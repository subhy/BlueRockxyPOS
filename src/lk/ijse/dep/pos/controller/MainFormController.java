        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                ...
                case "imgPurchaseOrder":
                    lblMenu.setText("Purchase Orders");
                    lblDescription.setText("Click if you want to Purchase orders");
                    break;
        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                ...
                case "imgOrder":
                    ...
                    break;
                case "imgViewOrders":
                    root =  FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/pos/view/loginReportForm.fxml"));
                    break;
                case "imgPurchaseOrder":
                    root =  FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/pos/view/PurchaseOrderForm.fxml"));
                    break;
            }
